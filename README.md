...
* __Vega Kiosks__
* __Finding Signal in the Noise with Regex__
...
* __From Create Lists to Action: Empowering Staff with API-Driven Micro-Projects__
...
* __I ❤️ Datasette: A Tool for Exploring and Publishing (Library) Data__
  
  Datasette is a free and open-source software platform designed by Simon Willison to make it easier to share and publish data. At the Cincinnati & Hamilton County Public Library I have been using Datasette in a variety of ways to help explore and share Library data in useful and meaningful ways that I’ll demo here.
